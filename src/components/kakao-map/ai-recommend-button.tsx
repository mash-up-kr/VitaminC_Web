...
const AiRecommendButton = () => {
  return (
    <button className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#E5684C] to-[#5D5FEF] p-[1px] transition-all duration-300 ease-in-out hover:w-40">
